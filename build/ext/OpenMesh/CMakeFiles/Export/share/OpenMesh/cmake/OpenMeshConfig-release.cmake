...
set_target_properties(OpenMeshCore PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOpenMeshCore.so.9.1"
  IMPORTED_SONAME_RELEASE "libOpenMeshCore.so.9.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS OpenMeshCore )
list(APPEND _IMPORT_CHECK_FILES_FOR_OpenMeshCore "${_IMPORT_PREFIX}/lib/libOpenMeshCore.so.9.1" )
...
set_target_properties(OpenMeshTools PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOpenMeshTools.so.9.1"
  IMPORTED_SONAME_RELEASE "libOpenMeshTools.so.9.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS OpenMeshTools )
list(APPEND _IMPORT_CHECK_FILES_FOR_OpenMeshTools "${_IMPORT_PREFIX}/lib/libOpenMeshTools.so.9.1" )
